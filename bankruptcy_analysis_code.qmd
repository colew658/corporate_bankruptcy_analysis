...
rm(year1, year2, year3, year4, year5, allyears, allyears_comp, allyears_imp, allyears_renamed)
...
base_probs_facet <- base_preds %>%
  ...
  theme_bw() +
  labs(x = "Probability Estimate of Bankrupcy", y = "Count", title = "Predicted Probabilty of Bankrupcy by Actual Outcome (Basic Logistic Regression)")
...
# 
# saveRDS(base_smote_tune, "/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/base_smote_tune.rds")
...
pca_scree <- pca_variance %>%
  ...
  geom_col() +
  theme_bw() +
  labs(x = "PC", y = "% Variance Explained", title = "Percentage Variance Explained by Each Principal Component")
...
# best over ratio
pca_smote_base_best_ratio <- pca_smote_base_tune %>% select_best(metric = "roc_auc")
...
# stopCluster(cl)
# 
# saveRDS(enet_base_tune, "/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/enet_base_tune.rds")
...
# stopCluster(cl)
# 
# saveRDS(enet_smote_tune, "/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/enet_smote_tune.rds")
...
enet_smote_probs_facet <- enet_smote_preds %>%
  ...
  facet_wrap(~ class_factor, ncol = 2, scales = "free") +
  theme_bw() +
  labs(x = "Probability Estimate of Bankrupcy", y = "Count", title = "Predicted Probabilty of Bankrupcy by Actual Outcome (Elastic Net w/ SMOTE)")
```
...
# stopCluster(cl)
# 
# saveRDS(pca_smote_enet_tune, "/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/pca_smote_enet_tune.rds")
...
# stopCluster(cl)
# 
# saveRDS(xgb_base_tune, '/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/xgb_base_tune.rds')
...
# 
# saveRDS(xgb_base_fit, '/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/xgb_base_fit.rds')
...
# stopCluster(cl)
# 
# saveRDS(xgb_smote_tune, '/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/xgb_smote_tune.rds')
...
# 			                                   sens, spec, brier_class))
# 
# saveRDS(xgb_smote_fit, '/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/xgb_smote_fit.rds')
...
xgb_smote_probs_facet <- xgb_smote_preds %>%
  ...
  facet_wrap(~ class_factor, ncol = 2, scales = "free") +
  theme_bw() +
  labs(x = "Probability Estimate of Bankrupcy", y = "Count", title = "Predicted Probabilty of Bankrupcy by Actual Outcome (XG Boost w/ SMOTE)")
...
xgb_smote_vip <- vip(xgb_smote_native) +
  ...
  scale_x_discrete(labels = c("POA_FE" = "Operating Profit / Financial Expenses",
...
# #
# 
# saveRDS(xgb_pca_smote_tune, '/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/xgb_pca_smote_tune.rds')
...
# 			                                   sens, spec, brier_class))
# 
# saveRDS(xgb_pca_smote_fit, '/Users/colewagner632/Library/CloudStorage/OneDrive-SouthernMethodistUniversity/STAT 6302/Projects/Final Project/xgb_pca_smote_fit.rds')
...
comb_metrics <- rbind(base_metrics_form, base_smote_metrics_form, pca_smote_base_metrics_form, enet_base_metrics_form,
...
lr_metrics_table <- kable(lr_comb_metrics, digits = 3, caption = "Table 1 - Basic Logistic Regression Model Comparison") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
lr_metrics_table
...
enet_metrics_table <- kable(enet_comb_metrics, digits = 3, caption = "Table 2 - Elastic Net Model Comparison") %>%
  kable_styling(bootstrap_options = "striped", full_width = F)
enet_metrics_table
